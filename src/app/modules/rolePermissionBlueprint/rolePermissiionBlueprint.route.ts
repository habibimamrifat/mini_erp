...
router.post(
  ...
  accessControl({
    ...
    requiredModuleAccess: ["blueprint"],
    requiredPermissionAccess: ["blueprint:create"],
  }),
...
router.get(
  ...
  accessControl({
    ...
    requiredModuleAccess: ["blueprint"],
    requiredPermissionAccess: ["blueprint:read"],
  }),
...
router.patch(
  ...
  accessControl({
    ...
    requiredModuleAccess: ["blueprint"],
    requiredPermissionAccess: ["blueprint:update"],
  }),
...
router.delete(
  ...
  accessControl({
    ...
    requiredModuleAccess: ["blueprint"],
    requiredPermissionAccess: ["blueprint:delete"],
  }),
